...
### 1. Installation
This project was written in Python, using Jupyter Notebook on Anaconda.  Python packages used for this project are as follows:
...
### 2.  Motivation
 As students in the nanodegree, we have the option to take part in the Starbucks Capstone Challenge.
